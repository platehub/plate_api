    ...
    context "with input only containing an id of an existing object" do
      ...
      context "with id that does not exist in Plate" do
        ...
        it "raises Response error" do
          expect { subject.find(5) }.to raise_error PlateApi::ResponseError
        end
      end
    end
  end
    ...
    context "with valid input for an existing object" do
      ...
      context "with id that exists in Plate" do
        ...
        context "with invalid update attributes" do
          ...
          it "raises Response error" do
            expect { subject.update(5, { "name" => nil }) }.to raise_error PlateApi::ResponseError
          end
        end
      end
      ...
      context "with id that does not exist in Plate" do
        ...
        it "raises Response error" do
          expect { subject.update(5, { "name" => "A New Name" }) }.to raise_error PlateApi::ResponseError
        end
      end
    end
  end
  ...
  describe "#delete" do
    context "with input only containing an id of an existing object" do
      ...
      context "with id that does not exist in Plate" do
        ...
        it "raises Response error" do
          expect { subject.delete(5) }.to raise_error PlateApi::ResponseError
        end
      end
    end
  end
